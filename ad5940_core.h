...
/* AD5940 key register addresses */
#define AD5940_REG_ADIID	0x0400
#define AD5940_REG_CHIPID	0x0404
#define AD5940_REG_INTCPOL	0x0000
#define AD5940_REG_INTCFLAG	0x0008
#define AD5940_REG_AFECON	0x2000
#define AD5940_REG_AFEADIID	0x0400
#define AD5940_REG_AFECHIPID	0x0404
#define AD5940_REG_FIFOICON	0x0A04
#define AD5940_REG_FIFOCNT	0x0A10
#define AD5940_REG_FIFODATA	0x0A14
...
/* Number of IIO channels (voltage + current + timestamp) */
#define AD5940_IIO_CHANNELS	3
...
static const struct {
	...
	{ 0x0908, 0x02c9 },
	{ 0x0c08, 0x206C },	/* Enable CS wakeup & SRAM retention   */
	{ 0x21F0, 0x0010 },
	{ 0x0410, 0x02c9 },	/* AD5940 (not M355)                   */
	{ 0x0A28, 0x0009 },	/* AD5940 clock gating                 */
	{ 0x238c, 0x0104 },
	{ 0x0a04, 0x4859 },	/* FIFO key 1                          */
	{ 0x0a04, 0xF27B },	/* FIFO key 2                          */
	{ 0x0a00, 0x8009 },	/* Enable FIFO read command             */
	{ 0x22F0, 0x0000 },
 ...
 * @iio_dev:    IIO device
 * @buffer:     IIO triggered buffer data
 */
struct ad5940_priv {
